...
![Precio semanal del maiz en la Ciudad de México](/Users/agutierrez/Documents/maestria/lineal-generalized-models/food-price-warning-indicator/images/df_semanal.png)
...
![Precio Internacional del Maiz](/Users/agutierrez/Documents/maestria/lineal-generalized-models/food-price-warning-indicator/images/internacional.png)


Podemos observar en la figura, una comparación entre las tendencias de los precios nacionales e internacionales.

![Precio Internacional del Maiz](/Users/agutierrez/Documents/maestria/lineal-generalized-models/food-price-warning-indicator/images/internacional_nacional.png)
...
## Modelo 1 Model Autoregressive AR(1) time series models
...
$$y_n \sim Normal(\alpha + \beta y_{n-1}, \sigma )$$

  This model introduces a coefficient, which we'll call $\beta$. The parameter $\phi$ controlls the degree to
  which the random walk reverts to the mean – when $\beta=1$, the model is identical to the random walk, but
  at smaller values, the model will revert back to the mean (which in this case is zero). Also, $\phi$ can take on
  negative values

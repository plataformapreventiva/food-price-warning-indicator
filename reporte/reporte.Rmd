...
"En México existen dos ciclos productivos en el cultivo del maíz: el de primavera-verano (PV) y el de otoño-invierno (OI). La época de siembra del maíz, tanto de riego como de temporal, se concentra en los meses de junio y julio para el ciclo PV y de noviembre a enero para el ciclo OI." 
...
Como primera aproximación se desarrollo un modelo de tendencia de segundo orden con componente  estacional. 

Esto se hizo dado que observamos que existe un componente estacional importante en los movimientos de los precios de los granos nacionales que se puede explicar por las temporadas de siembra y cosecha en el país. 

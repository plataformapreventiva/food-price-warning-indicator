# The R functions in this file have been modified (June 2007)- different from those in Version 1.0.
...
# Add this Venables and Ripley library to get the generalized inverse
library(MASS)
...
obj=list(Delta=del,Omega=OMEGA,Lambda=LAM,Xi0=XI0,Beta0=B0,Finv=Finv,Psi=PSI,
                     Hinv=Hinv,data=data, block= block,n.miss= n.miss,covariate=covariate)
return(obj)
}
...
obj = list(Delta.0 = delta.u, Delta = emfit$Delta, Lambda.0 = lambda.u, Lambda=emfit$Lambda,
  ...
  H.0= h.u,Hinv=emfit$Hinv, data=emfit$data, block= emfit$block, n.miss= emfit$n.miss, 
covariate=emfit$covariate)

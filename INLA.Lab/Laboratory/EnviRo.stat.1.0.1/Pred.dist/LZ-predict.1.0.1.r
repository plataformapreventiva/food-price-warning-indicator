# This functions has been modified (June 2007) - different from those in Version 1.0 
...
# Check if tpt is within range
if ((tpt <1)|(tpt>n))
stop(paste("The seleted time point is out of range (from 1 to",n,")"))
...
# Generate observations at ungauged sites conditional on y.g
 ...
 b0.0 = matrix(rep(b0[,1:p],u),nrow=dim(b0)[1])
 Zt = ZZ[tpt,]
